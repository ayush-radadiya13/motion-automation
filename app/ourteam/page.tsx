  ...
  return (
    <div>
      ...
      <div className="flex flex-col py-20 min-h-screen ">
        <motion.div
          className="relative py-12 flex flex-col items-center text-center space-y-6 px-4 sm:px-6 lg:px-8"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          variants={fadeUp}
        >
          ...
          {/* Title */}
          <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent animate-pulse">
            Our Teams
          </h1>

          {/* Subtitle */}
          <span className="text-lg sm:text-xl md:text-2xl font-semibold tracking-wide relative inline-block max-w-2xl">
        ...
        <main className="flex-grow space-y-12 px-4 sm:px-6 lg:px-8">
          {/* Directors Section */}
          <motion.section
            className="max-w-6xl mx-auto px-4 py-8 border-2 shadow-sm flex flex-col items-center space-y-6"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            variants={fadeUp}
